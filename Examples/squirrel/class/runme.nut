...
local c = example.Circle(10);
print("Created circle " + c + "\n");
local s = example.Square(10);
print("Created square " + s + "\n");

// ----- Access a static member -----
print("A total of " + example["Shape.nshapes"] + " shapes were created\n"); // access static member as properties of the module
...
// print("A total of " + example.Shape.nshapes + " shapes were created - this doesn't work.\n");
